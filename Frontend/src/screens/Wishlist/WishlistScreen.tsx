...
export const WishlistScreen = () => {
  ...
  // prepare grouping data for rendering
  ...
  // additional helper styles defined below
        ...
        <SectionList
          ...
          renderItem={({ item }: any) => {
            ...
            const discountPct = Math.round(
              ((product.originalPrice - lowestPrice) / product.originalPrice) *
                100,
            );
            return (
              <TouchableOpacity
...
// extracted separator component; defined after styles to avoid undefined reference
